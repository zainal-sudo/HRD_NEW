...
implementation
   uses ufrmLembur, ufrmLembur2, uModuleConnection, ufrmMenu, Ulib, uFrmPreviewImage;
{$R *.dfm}
...
procedure TfrmBrowseLembur.cxButton9Click(Sender: TObject);
var
...
begin
  ...
  if ActiveMDIChild.Caption <> 'Lembur' then
  begin
    frmlembur2 := frmmenu.ShowForm(TfrmLembur2) as TfrmLembur2;
    frmlembur2.dtTanggal.SetFocus;
  end;
