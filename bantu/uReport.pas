...
uses
  ...
  FMTBcd, DateUtils, DBClient, Provider, Forms,MyAccess, DBAccess, MemDS,
  Controls, ComObj,AdvCGrid,Dialogs,frxExportPDF;
...
//    function GetQueryPerusahaan: TMyQuery;
...
uses
  SysUtils,ufrmMenu,uModuleConnection;
...
begin
  ...
  FSQLQuery.Connection  := frmMenu.MyConnection1;
  DataSetProvider.DataSet := FSQLQuery;
