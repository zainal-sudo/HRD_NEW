...
type
  TfrmLembur = class(TForm)
    ...
    procedure dtJamAkhirExit(Sender: TObject);
...
begin
  ...
  begin
    ...
    s := 'INSERT INTO tlembur '
       + ' (lem_nomor, lem_kar_nik, lem_tanggal, lem_jammulai, lem_jamakhir, lem_keterangan, lem_foto, lem_poin) '
       + ' VALUES ( '
       + Quot(edtNomor.Text) + ','
       + Quot(edtNIK.Text) + ','
...
procedure TfrmLembur.dtJamAkhirExit(Sender: TObject);
var
  Poin: Double;
begin
