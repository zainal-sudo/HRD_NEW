...
begin
    ...
    Self.SQLMaster := ' WITH RECURSIVE dates AS (   '
                    ...
                    + '     LEFT JOIN tabsensitampung e ON ( '
                    + '       (x.kar_kd_unit = "20"  AND e.tanggal_kerja = d.dt) '
                    + '        OR (x.kar_kd_unit <> "20" AND DATE(e.tanggal) = d.dt) '
                    + '     ) AND e.kar_nik = emp.kar_nik '
                    ...
                    + '     i.ij_foto AS foto, i.keterangan AS KeteranganIjin '
                    + ' FROM status_dasar s '
